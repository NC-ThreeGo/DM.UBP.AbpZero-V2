...
namespace DM.UBP.Application.Service.ReportManager.ReportDataSources
{
    ...
    /// <summary>
    [AbpAuthorize(AppPermissions_ReportManager.Pages_ReportManager_ReportDataSources)]
    public class ReportDataSourceAppService : IReportDataSourceAppService
    {
        ...
        [AbpAuthorize(AppPermissions_ReportManager.Pages_ReportManager_ReportDataSources_Create)]
        ...
        [AbpAuthorize(AppPermissions_ReportManager.Pages_ReportManager_ReportDataSources_Edit)]
        ...
        [AbpAuthorize(AppPermissions_ReportManager.Pages_ReportManager_ReportDataSources_Delete)]
